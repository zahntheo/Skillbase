...
import { FaFingerprint, FaUser, FaRegEye, FaRegEyeSlash } from "react-icons/fa";
...
const RegisterForm = () => {
  ...
  return (
    <div className="w-full bg-black h-screen flex items-center justify-center">
      ...
      >
        <img src="/images/logo3.png" alt="logo" className="w-43" />
        ...
        <button className="w-full p-3 bg-white text-black rounded-lg mt-3 font-semibold hover:bg-gray-300 transition">
          Register
        </button>
